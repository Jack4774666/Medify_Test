...
I18N.shared = {
  en: { _name: "English", _dir: "ltr",
    ...
    "nav.search":"Search...","nav.searchButton":"Search","nav.cart":"Cart"
  },
  ku: { _name: "کوردی",
    "nav.home":"سەرەکی","nav.tutorial":"وانە","nav.about":"دەربارە","nav.contact":"پەیوەندی",
    "nav.search":"گەڕان...","nav.searchButton":"گەڕان","nav.cart":"سەبەتە"
  },
  ar: { _name: "العربية",
    "nav.home":"الرئيسية","nav.tutorial":"الدروس","nav.about":"من نحن","nav.contact":"تواصل",
    "nav.search":"ابحث...","nav.searchButton":"بحث","nav.cart":"عربة"
  }
};
